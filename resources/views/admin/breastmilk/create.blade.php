...
<div class="breadcrumb-header justify-content-between">
    <div class="left-content">
        <span class="main-content-title mg-b-0 mg-b-lg-1">Add Breastmilk</span>
    </div>
    <div class="justify-content-center mt-2">
        <ol class="breadcrumb">
            <li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Add Breastmilk</li>
...
<div class="row">
    <div class="col-12 col-sm-12">
        <form action="{{ route('breastmilk.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group mt-2">
                ...
                <input type="number" name="milk_quantity" class="form-control" required>
            </div>
