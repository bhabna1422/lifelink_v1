...
<div class="breadcrumb-header justify-content-between">
    <div class="left-content">
        <span class="main-content-title mg-b-0 mg-b-lg-1">Update donor</span>
    </div>
    <div class="justify-content-center mt-2">
        <ol class="breadcrumb">
            <li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Update donor</li>
            <li class="breadcrumb-item tx-15"><a href="{{ route('donors.index') }}" class="btn btn-info text-white">Manage donor</a></li>
        </ol>
    </div>
</div>
<!-- /breadcrumb -->
            ...
            <div class="mb-3">
                ...
                <select name="blood_id" class="form-control" required>
                    ...
                    @foreach($bloods as $blood)
                        <option value="{{ $blood->id }}" {{ old('blood_id', $donor->blood_id) == $blood->id ? 'selected' : '' }}>
                            {{ $blood->name }} ({{ $blood->blood_group }})
                        </option>
                    @endforeach
                </select>
            </div>
