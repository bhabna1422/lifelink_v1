...
@section('content')
    ...
    <tbody>
        @foreach($staffs as $index => $staff)
            @php
                // Check the meal types for each staff member
                $breakfast = $staff->meal === 'breakfast';
                $lunch = $staff->meal === 'lunch';
                $dinner = $staff->meal === 'dinner';
            @endphp
            ...
            <tr>
                ...
                <td>{{ $staff->name }}</td>
                <td>{{ $staff->date }}</td> <!-- Display the date -->
                <td>{{ ucfirst($staff->meal) }}</td>
            </tr>
        @endforeach
    </tbody>
</table>
